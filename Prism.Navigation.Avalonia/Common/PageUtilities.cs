...
namespace Prism.Common
{
    public static class PageUtilities
    {
        public static void InvokeViewAndViewModelAction<T>(object view, Action<T> action) where T : class
        {
            ...
            if (view is Visual element && element.DataContext is T viewModelAsT)
            {
                action(viewModelAsT);
            }
        }
        ...
        public static Task<bool> CanNavigateAsync(object page, INavigationParameters parameters)
        {
            ...
            if (page is Visual bindableObject)
            {
                if (bindableObject.DataContext is IConfirmNavigationAsync confirmNavigationBindingContext)
        ...
        public static bool CanNavigate(object page, INavigationParameters parameters)
        {
            ...
            if (page is Visual bindableObject)
            {
                if (bindableObject.DataContext is IConfirmNavigation confirmNavigationBindingContext)
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static void SetAutowireViewModel(Visual element)
        {
            ...
            else if (element.DataContext == element.Parent?.DataContext)
            {
            ...
            if ((type == typeof(NavigationPage)/* || type == typeof(TabbedPage)*/) && element.DataContext == null)
            {
